...
public class Custom_banner_patterns {
    ...
    // Create a Deferred Register to hold Items which will all be registered under the "custom_banner_patterns" namespace
    ...
    public Custom_banner_patterns(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Custom_banner_patterns) to respond directly to events.
